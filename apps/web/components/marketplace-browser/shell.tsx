...
export function BrowserShell({children}:{children:ReactNode}) {
  return <div className="min-h-screen bg-[#f7fafc] text-slate-900"><a href="#marketplace-main" className="sr-only focus:not-sr-only focus:fixed focus:z-50 focus:bg-white focus:p-4">Skip to content</a>
    <header className="border-b border-slate-200 bg-white"><div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-5">
      ...
      <nav aria-label="Marketplace navigation" className="flex gap-5 text-sm font-medium"><Link href="/marketplace/browser">My scans &amp; subscription</Link><a href="mailto:support@certscore.ai">Support</a></nav>
    ...
    <footer className="mt-14 border-t border-slate-200 bg-white px-6 py-8 text-xs leading-6 text-slate-500"><div className="mx-auto max-w-6xl">
      ...
      <p className="mt-3">© 2026 CertScore.ai, LLC</p></div></footer></div>;
}
